...
# ╔═╡ 3246ee2e-0c24-4544-9d2e-fe9a0d18803f
using LaTeXStrings, LinearAlgebra, Random, SparseArrays, Statistics


# ╔═╡ 32b7706f-c178-4611-8452-1199cb6ec052
using OrdinaryDiffEq, Parameters, Plots, Colors, PlutoUI

# ╔═╡ 1219f2f1-6038-4971-ab2a-545a78d0486d


# ╔═╡ 3c18647c-b632-11ed-0fbe-f5dca1871657
md"# SIR"

# ╔═╡ ad1fd847-7503-4403-b0d5-e3200e191f90


 

# ╔═╡ 6a2d221f-e16a-47c0-8c9f-480533aec8fe
md"
$(@bind β Slider(0:0.01:1,show_value=true))
$(@bind γ Slider(0.0001:0.01:1,show_value=true))
"

# ╔═╡ 2a265435-228b-47ee-936d-fe2e3823bde4
R_0 = β/γ	

# ╔═╡ 867f691a-86a7-4fb4-916a-c90e3079267b
...
# ╔═╡ 4c188f1a-1de9-4056-9ce9-edabf9a5429f
...
# ╔═╡ 310d6e79-3ba0-4ab7-9485-d3cd60366a2a
begin
i_0 = 1E-4
s_0 = 1.0- i_0 
r_0 = 0.0
...
# ╔═╡ 812cf11e-51e3-419d-b333-4957876a7c9c
begin
sol = solve(prob, Tsit5())
plot(sol, labels = [ L"s" L"i" L"r"], title = "SIR Dynamics", lw = 2, xlabel = L"t")
end 

# ╔═╡ b7c77fbc-d9ba-4c7f-a146-2c1a4c1a8b02
plot(sol,vars=(1,2),
    xlims=(0,1),ylims=(0,1),
    xlabel = L"s",
    ylabel = L"i",
...
# ╔═╡ 02e84bd5-85fc-4e8a-af53-f51521e968f2
md"# Automato Celular unidimensional na natureza
"

# ╔═╡ 81235e89-564e-4c29-84cb-ff0deae153e7
...
# ╔═╡ f0cd119d-a248-4b86-85b4-b2be6a34c57a
md"
nrow = $(@bind nrow Slider(10:500,show_value=true)) 

ncol = $(@bind ncol Slider(10:500,show_value=true))

num = $(@bind num Slider(1:255,show_value=true))
"

# ╔═╡ 7d7fe7d2-64bb-4f9f-b3a8-034dd1b6aa59
begin
locM = div(ncol,2)
St = zeros(Int,ncol)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "449770f2f9d4b3380d248f62532497a8b0fe3a2a"
